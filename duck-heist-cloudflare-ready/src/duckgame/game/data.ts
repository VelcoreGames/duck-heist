...
export const WEAPONS: Record<string, WeaponDef> = {
  ...
  breadcrumb_shotgun: {
    ...
    fireRate: 30, damage: 5, projectileSpeed: 4.8, projectileType: 'breadcrumb',
    spread: 0.48, projectileCount: 6, knockback: 3,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
  ...
  rubber_duck_cannon: {
    ...
    special: 'Cada rebote suma 15% de daño y acelera el patito.',
  ...
  baguette_launcher: {
    ...
    fireRate: 48, damage: 24, projectileSpeed: 3.2, projectileType: 'baguette',
  ...
  golden_egg_revolver: {
    ...
    description: 'Mucho daño, lento y preciso',
    special: 'Mantén la mira entre disparos: carga daño y probabilidad crítica.',
    fireRate: 38, damage: 28, projectileSpeed: 5.5, projectileType: 'golden_egg',
  ...
  tactical_toaster: {
    ...
    fireRate: 20, damage: 7, projectileSpeed: 4.4, projectileType: 'toast_stick',
  ...
  egg_cannon: {
    ...
    description: 'Huevos que se rompen en tres yemas balísticas.',
    special: 'Al impactar o romperse, libera tres yemas en abanico.',
    fireRate: 27, damage: 8, projectileSpeed: 3.8, projectileType: 'egg_shell',
    spread: 0, projectileCount: 1, knockback: 2,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
  ...
  baguette_sniper: {
    ...
    description: 'Francotirador de precisión y alto impacto.',
    special: 'Mantén la mira entre disparos para potenciar daño y crítico.',
    fireRate: 48, damage: 28, projectileSpeed: 9, projectileType: 'sniper_baguette',
  ...
  plasma_baker: {
    ...
    fireRate: 18, damage: 7, projectileSpeed: 4.7, projectileType: 'plasma_bread',
    spread: 0, projectileCount: 1, knockback: 2,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
  ...
  homing_crumbs: {
    ...
    special: 'Corrige la trayectoria hacia el enemigo más cercano.',
    fireRate: 11, damage: 5, projectileSpeed: 3.8, projectileType: 'homing_crumb',
...
const EXTRA_WEAPON_ROWS:any[][]=[["pico_percutor","PICO PERCUTOR","Pistola precisa de tres tiempos.","Cada tercer disparo atraviesa un objetivo y golpea más fuerte.",12,8,6.2,"beak_round",0.015,1,1.2,false,0,false,false,0,14,1,2,4,4,4],["nomina_42","NÓMINA .42","Revólver contable de alta precisión.","Probabilidad crítica elevada. Los críticos pueden soltar una migaja.",29,17,6.4,"ledger_round",0.01,1,2.5,false,0,false,false,0,21,2,4,2,4,4],["gomera_migas","GOMERA DE MIGAS","Migas endurecidas lanzadas con liga industrial.","Rebota dos veces y gana daño con cada pared.",16,7,5.3,"sling_crumb",0.04,1,1,false,2,false,false,0,13,1,2,3,5,4],["pistola_jarabe","PISTOLA DE JARABE","Munición pegajosa para controlar pasillos.","Cada impacto frena al enemigo durante unos segundos.",15,6,4.6,"syrup_blob",0.05,1,0.6,false,0,false,false,0,16,1,2,3,3,3],["paga_patos","PAGA-PATOS","Arma financiera que dispara fichas de bóveda.","Hace hasta 30% más daño según las migajas que cargas.",17,8,5.7,"cash_chip",0.035,1,1,false,1,false,false,0,20,2,3,3,4,4],["tronador_costra","TRONADOR DE COSTRA","Escopeta pesada de pan horneado.","Gran retroceso y devastación a quemarropa.",38,7,5,"crust_pellet",0.64,8,4.6,false,0,false,false,0,22,2,5,1,1,3],["horno_recortado","HORNO RECORTADO","Dos bocas, una pésima idea.","Dispara diez fragmentos muy juntos con una pausa larga.",46,6.2,5.5,"hot_crumb",0.48,10,5.2,false,0,false,false,0,26,3,5,1,1,4],["molinillo_pan","MOLINILLO DE PAN","Convierte la panadería en metralla.","Abanico enorme de migas de alcance corto.",31,3.2,4.2,"mill_crumb",1.05,12,3.2,false,0,false,false,0,19,1,4,2,1,3],["escopeta_mermelada","ESCOPETA DE MERMELADA","Perdigones dulces y extremadamente pegajosos.","Los impactos ralentizan; varios perdigones acumulan el efecto.",34,4.8,4.5,"jam_pellet",0.58,7,2.2,false,0,false,false,0,24,2,4,2,2,3],["rafaga_harina","RÁFAGA DE HARINA","Ametralladora ligera que llena la sala de polvo.","Cadencia altísima; compensa el daño bajo con volumen de fuego.",4,2.6,6.1,"flour_round",0.18,1,0.25,false,0,false,false,0,17,1,1,5,3,4],["subcuac_9","SUBCUAC 9","Subfusil compacto para atracos apresurados.","Rápida, estable y fiable mientras te mueves.",6,4.2,6.5,"subquack_round",0.11,1,0.4,false,0,false,false,0,18,1,2,5,3,5],["picoteadora_tactica","PICOTEADORA TÁCTICA","Ráfagas compactas de tres proyectiles.","Tres disparos casi paralelos para castigar blancos medianos.",14,4.8,6.6,"tactical_peck",0.1,3,0.8,false,0,false,false,0,21,2,3,4,4,5],["ventilador_servilletas","VENTILADOR DE SERVILLETAS","Lanza papel afilado en abanico.","Siete hojas cubren una zona enorme y una puede atravesar.",24,4.1,5.8,"napkin_blade",0.9,7,0.45,false,0,false,false,0,19,1,3,3,3,4],["cinta_transportadora","CINTA TRANSPORTADORA","Cadena industrial de disparos consecutivos.","Cada quinto disparo acelera y pega más fuerte.",5,3.4,6.4,"belt_bolt",0.08,1,0.35,false,0,false,false,0,23,2,2,5,4,5],["mortero_masa","MORTERO DE MASA","Bolas de masa explosiva de gran radio.","Lento y pesado; limpia grupos sin exigir puntería perfecta.",52,19,2.6,"mortar_dough",0.03,1,5,false,0,false,false,48,27,3,5,1,4,1],["gran_bagueton","GRAN BAGUETÓN","Una baguette absurda con propulsión propia.","Explosión enorme, mucho empujón y cadencia muy lenta.",68,31,3.4,"mega_baguette",0,1,7,false,0,false,false,68,36,4,5,1,4,2],["cazuela_volatil","CAZUELA VOLÁTIL","Recipiente blindado relleno de masa reactiva.","Rebota una vez; el rebote aumenta el daño antes de explotar.",43,16,3.8,"volatile_pan",0.04,1,4,false,1,false,false,0,25,3,4,2,4,2],["cohete_croqueta","COHETE DE CROQUETA","Proyectil rápido con una pequeña carga explosiva.","Mucho más veloz que otros explosivos; radio compacto.",35,15,6.7,"croquette_rocket",0.015,1,3,false,0,false,false,30,24,2,4,2,5,5],["canon_levadura","CAÑÓN DE LEVADURA","Masa expansiva que despeja espacio.","La explosión empuja con fuerza a los supervivientes.",47,18,3.5,"yeast_charge",0,1,8,false,0,false,false,50,28,3,4,1,4,2],["rayo_mostaza","RAYO DE MOSTAZA","Haz corrosivo amarillo de alcance medio.","Atraviesa y ralentiza a todo lo que toca.",3,2.2,8.2,"mustard_ray",0,1,0.15,true,0,true,false,0,27,3,2,5,4,5],["bobina_cuantica","BOBINA DE PAN CUÁNTICO","Descarga experimental entre objetivos cercanos.","Al impactar, salta a otro enemigo con daño reducido.",23,10,6.8,"quantum_bolt",0.02,1,0.8,false,0,false,false,0,30,3,4,3,4,5],["arco_tostado","ARCO DE TOSTADO","Electricidad de cocina mal aislada.","El impacto encadena dos descargas pequeñas a enemigos próximos.",17,7.2,6.2,"toast_arc",0.03,1,0.4,false,0,false,false,0,24,2,3,4,4,4],["migaja_negra","PROYECTOR DE MIGAJA NEGRA","Dispara una miga imposible que curva el espacio.","Mientras viaja atrae enemigos cercanos hacia su trayectoria.",39,13,2.8,"black_crumb",0,1,0.2,true,0,false,false,0,37,4,4,2,4,1],["sintetizador_cuac","SINTETIZADOR DE CUAC","Convierte un cuac en una pared de presión.","Cinco ondas perforantes empujan grupos completos.",28,5.8,5.4,"synth_quack",0.72,5,3.2,true,0,false,false,0,29,3,4,2,4,4],["paraguas_balistico","PARAGUAS BALÍSTICO","Seguridad bancaria en todas direcciones.","Dispara ocho proyectiles alrededor del pato sin importar la mira.",34,5.5,5.1,"umbrella_round",0,8,0.5,false,0,false,false,0,25,3,3,2,4,4],["caja_registradora","CAJA REGISTRADORA","Tickets, cambio y mala contabilidad.","Las bajas tienen probabilidad de soltar una migaja extra.",13,7,5.8,"register_ticket",0.12,2,0.6,false,0,false,false,0,22,2,3,4,3,4],["impresora_multas","IMPRESORA DE MULTAS","Papel oficial a velocidades poco oficiales.","Tiras veloces atraviesan hasta dos enemigos.",8,4.4,8,"fine_strip",0.035,1,0.2,false,0,false,false,0,22,2,2,5,5,5],["rodillo_cocina","RODILLO DE COCINA","No todo atraco necesita balas.","Golpe frontal de alcance mínimo, daño enorme y empujón brutal.",30,24,4.7,"rolling_pin",0,1,9,true,0,false,false,0,20,2,5,2,1,3],["iman_boveda","IMÁN DE BÓVEDA","Campo magnético portátil de procedencia dudosa.","El orbe desvía y puede devolver proyectiles enemigos cercanos.",41,8,2,"vault_magnet_orb",0,1,0.2,true,0,false,false,0,34,4,3,1,4,1],["pato_orbital","PATO DE GOMA ORBITAL","Patitos tácticos que primero protegen y luego cazan.","Orbita brevemente alrededor de ti y después busca un enemigo.",24,9,4.9,"orbit_duck",0.25,2,1.2,false,1,false,false,0,35,4,4,3,5,3]];
...
WEAPONS.quack_blaster.fireRate=23;WEAPONS.quack_blaster.damage=6;WEAPONS.quack_blaster.knockback=1.1;WEAPONS.quack_blaster.bars={dmg:2,rate:1,range:3,speed:3};
...
export type SkinOverlay =
  ...
  | 'ninja' | 'undercover' | 'pirate' | 'gold' | 'king' | 'space_green';
...
SKINS.push({id:'jalo_verde',name:'JALO VERDE',description:'Armadura verde de asalto espacial, casco reforzado y visor dorado.',cost:450,palette:{...DEFAULT_PALETTE,body:'#66783d',dark:'#42502d',shade:'#2d3923',beak:'#d89a34',beakDark:'#a76b20',mask:'#151b19',pack:'#283126',strap:'#1d241d'},overlay:'space_green'});
