...
const rules:[RegExp,string][]=[[/^PISO (\d+)\/6$/,'FLOOR $1/6'],[/^PISO (\d+)$/,'FLOOR $1'],[/^ASPECTOS (\d+) \/ (\d+)$/,'ASPECTS $1 / $2'],[/^DESCUBIERTOS · (\d+) \/ (\d+)$/,'DISCOVERED · $1 / $2'],[/^MONEDAS DORADAS: (\d+)$/,'GOLDEN COINS: $1'],[/^Monedas doradas: (\d+)$/,'Golden coins: $1'],[/^MIGAJAS: (\d+)$/,'CRUMBS: $1'],[/^DAÑO (.+)$/,'DAMAGE $1'],[/^PRECIO (.+)$/,'PRICE $1'],[/^COMPRAR ASPECTO · (\d+)$/,'BUY ASPECT · $1']];
