import { CANVAS_WIDTH, UI_OFFSET_X } from './constants';
...
export const MAIN_MENU={x:26+UI_OFFSET_X,y:80,w:145,h:24,gap:3,count:8};
...
export const DIFFICULTY_GRID={x:46+UI_OFFSET_X,y:82,w:186,h:78,gapX:14,gapY:12,cols:2,count:4};
...
export const DIFFICULTY_START:Rect={x:306+UI_OFFSET_X,y:318,w:128,h:22};

export const PAUSE_MENU={x:44+UI_OFFSET_X,y:74,w:188,h:35,gapX:12,gapY:8,cols:2,count:7};
...
export const CONFIRM_RECTS:[Rect,Rect]=[
  {x:250+UI_OFFSET_X,y:230,w:150,h:34}, // confirmar
  {x:80+UI_OFFSET_X,y:230,w:150,h:34},  // cancelar
];

export const BACK_BUTTON:Rect={x:28+UI_OFFSET_X,y:318,w:92,h:22};
export const PRIMARY_BUTTON:Rect={x:326+UI_OFFSET_X,y:318,w:126,h:22};
export const CONTROLS_RESET:Rect={x:326+UI_OFFSET_X,y:318,w:126,h:22};
export const MAP_CLOSE:Rect={x:356+UI_OFFSET_X,y:318,w:96,h:22};
export const HUD_MENU:Rect={x:CANVAS_WIDTH-126,y:6,w:40,h:17};
export const SWAP_CANCEL:Rect={x:176+UI_OFFSET_X,y:309,w:128,h:24};

export const SETTINGS={x:34+UI_OFFSET_X,y:82,w:202,h:26,gapX:8,gapY:6,cols:2,rows:6};
...
export const UPGRADE_CARD={x:38+UI_OFFSET_X,y:76,w:404,h:50,gap:6,count:4};
...
export const ENDLESS_RESUME={x:85+UI_OFFSET_X,y:150,w:310,h:42,gap:10,count:2};
...
export const ENDLESS_SECONDARY:Rect={x:120+UI_OFFSET_X,y:280,w:240,h:28};

export const END_ACTIONS={x:140+UI_OFFSET_X,y:290,w:200,h:22,gap:4,count:2};
...
export const SWAP_LAYOUT={x:35+UI_OFFSET_X,y:51,w:410,h:250,cardsY:171,cardW:185,cardH:84,gap:8};
...
export const ACTIVE_SWAP={x:95+UI_OFFSET_X,y:78,w:290,h:196,confirm:{x:118+UI_OFFSET_X,y:228,w:110,h:28},cancel:{x:252+UI_OFFSET_X,y:228,w:110,h:28}};
...
export const WARDROBE={x:203+UI_OFFSET_X,y:70,w:252,h:228,cols:3,cellW:76,cellH:94,gap:6};
export const WARDROBE_ACTION={x:43+UI_OFFSET_X,y:276,w:135,h:23};
...
export const COLLECTION={x:200+UI_OFFSET_X,y:106,w:251,h:200,cols:4,cellW:53,cellH:56,gap:8};
export const COLLECTION_FILTER:Rect={x:196+UI_OFFSET_X,y:81,w:78,h:20};
export const COLLECTION_SORT:Rect={x:279+UI_OFFSET_X,y:81,w:78,h:20};
export const COLLECTION_CAREER:Rect={x:362+UI_OFFSET_X,y:81,w:90,h:20};
