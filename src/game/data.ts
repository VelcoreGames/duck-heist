...
export const WEAPONS: Record<string, WeaponDef> = {
  // Los IDs se conservan para no romper partidas guardadas, estadísticas ni
  // sinergias existentes. Visualmente y en gameplay el arsenal fue rehecho
  // como armas de fuego reales por categoría, calibre y función.
  quack_blaster: {
    id: 'quack_blaster', name: 'PISTOLA 9 MM',
    description: 'Pistola semiautomática equilibrada y fiable.',
    special: 'Control sencillo, retroceso bajo y buena precisión en movimiento.',
    fireRate: 11, damage: 7, projectileSpeed: 8.5, projectileType: 'pistol_round',
    spread: .035, projectileCount: 1, knockback: 1,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 0, rarity: 0, bars: { dmg: 2, rate: 3, range: 3, speed: 4 },
  },
  breadcrumb_shotgun: {
    id: 'breadcrumb_shotgun', name: 'ESCOPETA 12 GA',
    description: 'Escopeta de corredera para distancias cortas.',
    special: 'Ocho perdigones por disparo y retroceso fuerte.',
    fireRate: 34, damage: 4.5, projectileSpeed: 6.2, projectileType: 'buckshot_player',
    spread: .68, projectileCount: 8, knockback: 4,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 16, rarity: 1, bars: { dmg: 5, rate: 1, range: 1, speed: 3 },
  },
  feather_gun: {
    id: 'feather_gun', name: 'SUBFUSIL 9 MM',
    description: 'Subfusil compacto de alta cadencia.',
    special: 'Excelente volumen de fuego; pierde precisión cuando se calienta.',
    fireRate: 4, damage: 3, projectileSpeed: 8.2, projectileType: 'smg_round',
    spread: .13, projectileCount: 1, knockback: .45,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 20, rarity: 1, bars: { dmg: 1, rate: 5, range: 2, speed: 4 },
  },
  bread_boomerang: {
    id: 'bread_boomerang', name: 'CARABINA 5.56',
    description: 'Carabina ligera para fuego rápido y preciso.',
    special: 'Cadencia alta, trayectoria tensa y excelente control.',
    fireRate: 7, damage: 6, projectileSpeed: 10, projectileType: 'rifle_556',
    spread: .045, projectileCount: 1, knockback: 1.2,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 21, rarity: 2, bars: { dmg: 2, rate: 4, range: 4, speed: 5 },
  },
  rubber_duck_cannon: {
    id: 'rubber_duck_cannon', name: 'FUSIL 7.62',
    description: 'Fusil de batalla contundente y estable.',
    special: 'Más daño y retroceso que una carabina; exige controlar la cadencia.',
    fireRate: 11, damage: 10, projectileSpeed: 10.5, projectileType: 'rifle_762',
    spread: .065, projectileCount: 1, knockback: 2.6,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 24, rarity: 2, bars: { dmg: 4, rate: 3, range: 4, speed: 5 },
  },
  baguette_launcher: {
    id: 'baguette_launcher', name: 'LANZAGRANADAS 40 MM',
    description: 'Lanzagranadas de un disparo con daño de área.',
    special: 'Proyectil lento; la detonación cubre un radio amplio.',
    fireRate: 48, damage: 24, projectileSpeed: 4, projectileType: 'grenade_40mm',
    spread: .02, projectileCount: 1, knockback: 6,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    explode: 58, cost: 28, rarity: 3, bars: { dmg: 5, rate: 1, range: 3, speed: 2 },
  },
  quack_laser: {
    id: 'quack_laser', name: 'AMETRALLADORA LIGERA 5.56',
    description: 'Arma automática sostenida para controlar la sala.',
    special: 'Cadencia muy alta, cargador conceptual amplio y dispersión moderada.',
    fireRate: 4, damage: 4, projectileSpeed: 9, projectileType: 'lmg_556',
    spread: .11, projectileCount: 1, knockback: .7,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 27, rarity: 3, bars: { dmg: 2, rate: 5, range: 3, speed: 5 },
  },
  golden_egg_revolver: {
    id: 'golden_egg_revolver', name: 'REVÓLVER .357',
    description: 'Revólver de gran potencia por disparo.',
    special: 'Mantén la mira para estabilizar el tiro y aumentar el daño.',
    fireRate: 29, damage: 18, projectileSpeed: 10, projectileType: 'magnum_round',
    spread: .025, projectileCount: 1, knockback: 3.4,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 29, rarity: 3, bars: { dmg: 4, rate: 2, range: 4, speed: 5 },
  },
  tactical_toaster: {
    id: 'tactical_toaster', name: 'PISTOLA .45 SUPRIMIDA',
    description: 'Pistola de calibre grande con sonido amortiguado.',
    special: 'Menor firma sonora, disparo estable y daño superior a la 9 mm.',
    fireRate: 13, damage: 9, projectileSpeed: 8.3, projectileType: 'suppressed_45',
    spread: .04, projectileCount: 1, knockback: 1.3,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 22, rarity: 2, bars: { dmg: 3, rate: 3, range: 3, speed: 4 },
  },
  egg_cannon: {
    id: 'egg_cannon', name: 'DMR 7.62',
    description: 'Fusil semiautomático de precisión para media y larga distancia.',
    special: 'Daño alto por tiro, precisión elevada y penetración ligera.',
    fireRate: 19, damage: 16, projectileSpeed: 11, projectileType: 'dmr_round',
    spread: .018, projectileCount: 1, knockback: 2.4,
    piercing: true, bounces: 0, continuous: false, boomerang: false,
    cost: 27, rarity: 3, bars: { dmg: 4, rate: 2, range: 5, speed: 5 },
  },
  baguette_sniper: {
    id: 'baguette_sniper', name: 'FUSIL CERROJO .308',
    description: 'Fusil de cerrojo para disparos de máxima precisión.',
    special: 'Daño muy alto, perforación y cadencia deliberadamente lenta.',
    fireRate: 46, damage: 30, projectileSpeed: 12, projectileType: 'sniper_308',
    spread: .005, projectileCount: 1, knockback: 4.2,
    piercing: true, bounces: 0, continuous: false, boomerang: false,
    cost: 30, rarity: 4, bars: { dmg: 5, rate: 1, range: 5, speed: 5 },
  },
  plasma_baker: {
    id: 'plasma_baker', name: 'RIFLE PESADO .50',
    description: 'Rifle pesado de largo alcance y enorme energía por impacto.',
    special: 'Mantén la mira para estabilizar: el disparo gana daño y penetración.',
    fireRate: 58, damage: 34, projectileSpeed: 11.5, projectileType: 'heavy_50',
    spread: .004, projectileCount: 1, knockback: 7,
    piercing: true, bounces: 0, continuous: false, boomerang: false,
    cost: 34, rarity: 4, bars: { dmg: 5, rate: 1, range: 5, speed: 5 },
  },
  homing_crumbs: {
    id: 'homing_crumbs', name: 'PDW 5.7',
    description: 'Arma compacta de defensa personal con alta velocidad.',
    special: 'Muy rápida, poco retroceso y buena precisión en ráfagas.',
    fireRate: 5, damage: 3.5, projectileSpeed: 9.5, projectileType: 'pdw_57',
    spread: .09, projectileCount: 1, knockback: .35,
    piercing: false, bounces: 0, continuous: false, boomerang: false,
    cost: 19, rarity: 2, bars: { dmg: 1, rate: 5, range: 3, speed: 5 },
  },
};
