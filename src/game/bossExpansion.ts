...
const LEGACY_STATS:Record<string,Partial<BossDef>>={
  ...
  head_baker:{hp:190,speed:1.18,size:38,scaleX:.90,scaleY:1.36,role:'reactor',roleVariant:0},
  el_auditor:{hp:185,speed:1.24,size:34,scaleX:.68,scaleY:1.52,role:'executioner',roleVariant:1},
  ganso_antidisturbios:{hp:220,speed:.88,size:43,scaleX:1.52,scaleY:.80,role:'bulwark',roleVariant:2},
  cajero_3000:{hp:230,speed:.06,size:50,scaleX:1.60,scaleY:.84,stationary:true,role:'artillery',roleVariant:3},
  captain_honk:{hp:260,speed:1.5,size:40,scaleX:1.00,scaleY:1.20,role:'swarm',roleVariant:0},
  comisario_pico_duro:{hp:300,speed:1.34,size:39,scaleX:.82,scaleY:1.34,role:'executioner',roleVariant:1},
  toaster_9000:{hp:340,speed:.06,size:58,scaleX:1.64,scaleY:.80,stationary:true,role:'reactor',roleVariant:2},
  general_ganso:{hp:380,speed:1.10,size:46,scaleX:.82,scaleY:1.40,role:'charger',roleVariant:3},
  don_levadura:{hp:360,speed:.82,size:54,scaleX:1.34,scaleY:1.22,role:'vortex',roleVariant:0},
  director_seguridad:{hp:420,speed:.06,size:64,scaleX:1.70,scaleY:.92,stationary:true,role:'warden',roleVariant:1},
};
