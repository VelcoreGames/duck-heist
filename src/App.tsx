...
import {
  ...
  inside, COLLECTION, COLLECTION_CAREER, CONTROLS_RESET, MAP_CLOSE, HUD_MENU, activeSwapHit, endlessRewardHit, resultButtonHit,
} from './game/layout';
  ...
  useEffect(() => {
    ...
    const onMove = (ev: MouseEvent) => {
      ...
      if(st===GameState.MENU){
        ...
        const i=resultButtonHit(p.x,p.y);if(i>=0&&engine.pauseIndex!==i){engine.pauseIndex=i;softMove();}
